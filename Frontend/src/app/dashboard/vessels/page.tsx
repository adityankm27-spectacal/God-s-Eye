...
/** The illustrative demo: a fixed mock incident with a fixed mock fleet, used
 *  when no real job is loaded. Kept byte-for-byte as the pitch deck view. */
function MockVesselAttribution() {
...
function VesselsContent() {
  ...
  return jobId ? <VesselAttributionView initialJobId={jobId} /> : <MockVesselAttribution />;
}
