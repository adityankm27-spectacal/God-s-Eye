...
export interface ShaderBackgroundUniforms {
...
const DEFAULT_UNIFORMS: Required<ShaderBackgroundUniforms> = {
  colors: [[0.011764705882352941,0.10980392156862745,0.14901960784313725],[0.10588235294117647,0.4235294117647059,0.6588235294117647],[0.35294117647058826,0.8235294117647058,0.9568627450980393],[0.9176470588235294,0.9764705882352941,1],[0.9176470588235294,0.9764705882352941,1],[0.9176470588235294,0.9764705882352941,1],[0.9176470588235294,0.9764705882352941,1],[0.9176470588235294,0.9764705882352941,1]],
  colorCount: 4,
  scale: 1.300,
  intensity: 0.560,
  paramA: 0.670,
...
export function ShaderBackground({
  ...
  className?: string
  /** Override any of the default shader parameters (colours, motion, etc). */
  uniforms?: ShaderBackgroundUniforms
}) {
  const canvasRef = useRef<HTMLCanvasElement>(null)
  const UNIFORMS = { ...DEFAULT_UNIFORMS, ...uniforms }
  ...
  useEffect(() => {
    ...
    function render(now: number) {
      ...
      resizeCanvas()
      // canvas/gl are guaranteed non-null here — both bail out of the effect
      // early when absent — but TS's narrowing from that guard doesn't reach
      // into this nested function's closure, hence the assertions.
